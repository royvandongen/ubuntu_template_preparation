...
# credits: base provided from https://github.com/fabianlee/tf-vsphere-singlevm-from-template
#
...
# basic OS packages
sudo apt install vim git zip unzip curl wget dnsutils traceroute open-vm-tools -y
